            ...
            <Container >
                <div >
                    <div className="ProfileimgContainer text-center">
                        ...
                        {/* Profile image here */}
                        <img class="roundedCircle profileimg" src={profile}></img>
                    ...
                    <div className="DetailContainer text-center">
                        ...
                        <div className="badgebox">
                            ...
                            <Badge bg="dark">
                                JAVA
                            </Badge>{' '} {/* this must includde */}
                        </div>

                        {/* Discription will come here */}
                        <div id="Discription" className="text-center">
                            Hello, I am software engeneer at TCS, having four years of experience in tech industry
                            and a mentor. I have gueded more than hundred individuals.
                        </div>
